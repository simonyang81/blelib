...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new br.com.brasizza.marcus.wifi_info_plugin_plus.WifiInfoPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin wifi_info_plugin_plus, br.com.brasizza.marcus.wifi_info_plugin_plus.WifiInfoPlugin", e);
    }
  }
}
